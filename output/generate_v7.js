...
const hdrB = (t) => ({ text: t, options: { bold: true, color: "000000", fill: { color: BLUE }, fontSize: 9, fontFace: "Calibri", align: "center", valign: "middle", border: [noBorder, noBorder, hdrBBot, noBorder] } });
const hdrG = (t) => ({ text: t, options: { bold: true, color: "000000", fill: { color: GREEN }, fontSize: 9, fontFace: "Calibri", align: "center", valign: "middle", border: [noBorder, noBorder, hdrBBot, noBorder] } });
...
const cB = (t) => ({ text: t, options: { color: "333333", fill: { color: BLUE }, fontSize: 8, fontFace: "Calibri", valign: "middle", border: [hBorder, noBorder, hBorder, noBorder] } });
const cG = (t) => ({ text: t, options: { color: "333333", fill: { color: GREEN }, fontSize: 8, fontFace: "Calibri", valign: "middle", border: [hBorder, noBorder, hBorder, noBorder] } });
...
slide.addTable(rows, {
  x: 0.4, y: 1.26, w: 9.2, h: 2.8,
  border: noBorder,
  colW: [1.2, 2.65, 2.65, 2.7],
  rowH: [0.3, 0.4, 0.38, 0.5, 0.4, 0.28],
  autoPage: false
});
...
pres.writeFile({ fileName: "/Users/lifeichen/Skill-Forge/output/slide_v7.pptx" })
  .then(() => console.log("Created slide_v7.pptx"))
