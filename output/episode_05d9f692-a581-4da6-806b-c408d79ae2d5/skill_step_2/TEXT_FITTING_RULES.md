...
- The source text and footer occupy the **bottom 0.9" of the slide** (from y=6.6" to y=7.5")
- Reserved vertical zones (standardized positions):
  - **y = 6.5"**: Hard stop for body content (nothing below this)
  - **y = 6.6"**: Source text starts here ("Source: ...")
  - **y = 6.9"**: Footer divider line
  - **y = 7.0"**: Footer text (CONFIDENTIAL + page number)
  - **y = 7.5"**: Slide bottom edge
- **Body content (including bottom metrics/callouts) must NOT extend below y=6.5"**
- There must be at least 0.1" clear gap between the lowest body element and the source text
